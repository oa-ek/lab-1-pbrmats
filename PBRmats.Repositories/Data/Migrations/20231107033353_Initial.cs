    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AvgColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AvgSpecularColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AvgMetallic = table.Column<float>(type: "real", nullable: false),
                    AvgIOR = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaterialMaterialsCollection", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaterialMaterialsCollection_Materials_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaterialMaterialsCollection_MaterialId",
                table: "MaterialMaterialsCollection",
                column: "MaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_MaterialMaterialsCollection_MaterialsCollectionId",
                table: "MaterialMaterialsCollection",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaterialsCollections_AppUserId",
